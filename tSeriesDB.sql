...
--
-- Estructura de tabla `ruleEngine`
--
...
--
-- Llenado de datos para tabla `ruleEngine`
--
...
--
-- Llenado de datos para tabla `thingData`
--
...
--
-- AUTO_INCREMENT de tabla `ruleEngine`
--
ALTER TABLE `ruleEngine`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabla `thingData`
--
ALTER TABLE `thingData`
